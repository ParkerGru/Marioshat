	...
	override public function create()
	{
		...
		switch(stageCheck)
		{
			...
			case 'kart':
				defaultCamZoom = 0.98;
				curStage = 'kart';
				var halloweenBG:FlxSprite = new FlxSprite(-350, -250);
				halloweenBG.frames = Paths.getSparrowAtlas('track');
				halloweenBG.animation.addByPrefix('idle', 'track0');
				halloweenBG.animation.play('idle');
				halloweenBG.antialiasing = true;
				add(halloweenBG);
			...
			default:
			{
				defaultCamZoom = 0.98;
				curStage = 'kart';
				var halloweenBG:FlxSprite = new FlxSprite(-280, -250);
				halloweenBG.frames = Paths.getSparrowAtlas('track');
				halloweenBG.animation.addByPrefix('idle', 'track0');
				halloweenBG.animation.play('idle');
				halloweenBG.antialiasing = true;
		...
		boyfriend = new Boyfriend(770, 310, SONG.player1);
